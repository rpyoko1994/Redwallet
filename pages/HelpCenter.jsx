  ...
  return (
    <div className="min-h-screen">
      <div className="degradado-rojo h-2/5">
        <div className="lineas w-full">
          ...
          <div className="max-w-4xl mx-auto  p-6">
            <h1 className="text-2xl text-white font-bold  mb-6">Hi, how can we help?</h1>
      ...
      <button className="w-full px-6">
        <div className="w-full border-2 rounded-2xl border-gray-500 p-4 flex items-center justify-between mb-4">
            <div className="mr-4 w-1/2">
              <img src="../src/assets/discord.svg" alt="Discord" className="w-12 h-12 rounded-full " />
            </div>
      ...
      <button className="w-full px-6">
        <div className="w-full border-2 rounded-2xl border-gray-500 p-4 flex items-center justify-between mb-4">
            <div className="mr-4 w-1/2">
              <img src="../src/assets/telegram.svg" alt="telegram" className="w-12 h-12 rounded-full " />
            </div>
            <div className="text-start w-full">
