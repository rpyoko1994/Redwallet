...
const PaymentMethod = () => {
  ...
  return (
    <div className="min-h-screen ">
      <NavbarRetroceso title="Payment Method" />
      ...
      <div className="px-6 py-2">
        ...
        <div
          className={`w-full border-2 border-gray-800 rounded-2xl p-4 flex items-center justify-between mb-2 ${
            selectedOption === "Visa"
              ? " text-red-500 ring-red-500 focus:ring-red-500"
              : "border-gray-600"
          }`}
      ...
      <div className="px-6">
        <div className="text-white text-xl font-semibold mb-2">E-Wallet</div>
